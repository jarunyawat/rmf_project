...
def generate_launch_description():
    ...
    pose = {'x': LaunchConfiguration('x_pose', default='-9.1'),
            'y': LaunchConfiguration('y_pose', default='-4.67'),
    ...
    declare_model_cmd = DeclareLaunchArgument(name='model', default_value=default_model_path,
    ...
    # os.path.join(sam_bot_dir, 'map', 'office_map.yaml')
    ...
    robot_localization_node = Node(
            ...
            output='screen',
            namespace=namespace,
            parameters=[os.path.join(sam_bot_nav_dir, 'config/ekf.yaml'), {'use_sim_time': use_sim_time}],
            remappings=[('/tf', 'tf'),
                  ('/tf_static', 'tf_static')]
    )
